function showTime() { 
	...
	var startDate = new Date(2017, 6, 21);
	...
	if (seconds < 10) 
	seconds = "0" + seconds; 
	var currentTimeString = "Dear ling:<br>"
		...
		+	"<c style=\"color: #CCCCCC; text-shadow:2px 3px 3px #222; font-family:Microsoft YaHei; font-size:20px\" >----zhijun  2018-05-20</c>"; 
